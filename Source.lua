...
local redzlib = {
  Themes = {
    Blue = {
      ["Color Hub 1"] = ColorSequence.new({
        ColorSequenceKeypoint.new(0.00, Color3.fromRGB(20, 40, 90)),
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(30, 60, 130)),
        ColorSequenceKeypoint.new(1.00, Color3.fromRGB(20, 40, 90))
      }),
      ["Color Hub 2"] = Color3.fromRGB(25, 50, 110),   -- خلفية القوائم
      ["Color Stroke"] = Color3.fromRGB(40, 80, 160), -- حدود الأزرار/القوائم
      ["Color Theme"] = Color3.fromRGB(65, 150, 255), -- لون الأزرار الأساسي (أزرق فاتح)
      ["Color Text"] = Color3.fromRGB(255, 255, 255), -- النص أبيض
      ["Color Dark Text"] = Color3.fromRGB(200, 200, 200) -- النص الغامق أبيض فاتح
    },
  },
  Info = {
    Version = "1.1.0"
  ...
  Save = {
    UISize = {434,247},
    TabSize = 160,
    Theme = "Blue" -- ✅ الأزرق صار الافتراضي
  },
}
  Settings = {},
  Connection = {},
